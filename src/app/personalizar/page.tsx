        ...
        <div className="mt-7 grid gap-4 md:grid-cols-2">
          ...
          <section className="refinement-section">
            ...
            <div className="mt-4 grid gap-4">
              ...
              <label><span className="field-label">Posición académica oficial</span><select value={facts.academicRank} onChange={(event) => patch({ academicRank: event.target.value as ProfileFacts["academicRank"] })} className="field-control cursor-pointer"><option value="unknown">No la conozco</option><option value="top_tenth">Décimo superior</option><option value="top_fifth">Quinto superior</option><option value="top_third">Tercio superior</option><option value="none">Ninguna de estas</option></select><span className="field-help">Solo declárala si figura en una constancia oficial.</span></label>
            </div>
          </section>
