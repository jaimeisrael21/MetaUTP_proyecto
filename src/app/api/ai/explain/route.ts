...
function fallback(title: string, signals: z.infer<typeof signalSchema>[], actionNote?: string, clarification?: string): Explanation {
  ...
  if (clarification && nextSteps.length < 3) nextSteps.push(clarification);
